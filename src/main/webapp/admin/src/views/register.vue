    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">网上订餐系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        -->
                        <!--
                            <el-form-item label="账户状态" class="input" v-if="tableName=='yonghu'">
...
.container {
    ...
    background-repeat: no-repeat;
        background-image: url(/wangshangdingcan/img/back-img-bg.jpg);
