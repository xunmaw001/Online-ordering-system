        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '美食资讯名称' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.zixunName" placeholder="美食资讯名称" clearable></el-input>
                     </el-form-item>
                 
                     <el-form-item :label="contents.inputTitle == 1 ? '美食资讯类型' : ''">
                        <el-select v-model="searchForm.zixunTypes" placeholder="请选择美食资讯类型">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/wangshangdingcan/upload/zixunMuBan.xls"
                        >批量导入美食资讯数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('zixun','导入导出')"
