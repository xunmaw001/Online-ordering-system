        ...
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12" v-if="sessionTable !='caipin' ">
                    <el-form-item class="upload" v-if="type!='info' && !ro.caipinPhoto" label="菜品照片" prop="caipinPhoto">
                        <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (caipinForm.caipinPhoto || '').split(',')" :src="$base.url+item" width="100" height="100">
                    </el-form-item>
                    <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="订单编号" prop="caipinOrderUuidNumber">
                       <el-input v-model="ruleForm.caipinOrderUuidNumber"
                                 placeholder="订单编号" clearable  :readonly="ro.caipinOrderUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="订单编号" prop="caipinOrderUuidNumber">
                           <el-input v-model="ruleForm.caipinOrderUuidNumber"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item v-if="type!='info' && !ro.caipinOrderTime"  class="input" label="预约时间" prop="caipinOrderTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.caipinOrderTime"
                                type="datetime"
                                placeholder="预约时间"
                                :disabled="ro.caipinOrderTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.caipinOrderTime" label="预约时间" prop="caipinOrderTime">
                            <span v-html="ruleForm.caipinOrderTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="派送人" prop="caipinOrderCourierName">
                       <el-input v-model="ruleForm.caipinOrderCourierName"
                                 placeholder="派送人" clearable  :readonly="ro.caipinOrderCourierName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="派送人" prop="caipinOrderCourierName">
                           <el-input v-model="ruleForm.caipinOrderCourierName"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="联系方式" prop="caipinOrderCourierNumber">
                       <el-input v-model="ruleForm.caipinOrderCourierNumber"
                                 placeholder="联系方式" clearable  :readonly="ro.caipinOrderCourierNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="联系方式" prop="caipinOrderCourierNumber">
                           <el-input v-model="ruleForm.caipinOrderCourierNumber"
    ...
    export default {
        data() {
            return {
                ...
                yonghuForm: {},
                ro:{
                    caipinOrderUuidNumber: true,
                    addressId: false,
                    caipinId: false,
                    yonghuId: false,
                    buyNumber: false,
                    caipinOrderTime: false,
                    caipinOrderTruePrice: false,
                    caipinOrderCourierName: false,
                    caipinOrderCourierNumber: false,
