    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="菜品库存" prop="caipinKucunNumber">
                       <el-input v-model="ruleForm.caipinKucunNumber"
                                 placeholder="菜品库存" clearable  :readonly="ro.caipinKucunNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="菜品原价" prop="caipinOldMoney">
                       <el-input v-model="ruleForm.caipinOldMoney"
                                 placeholder="菜品原价" clearable  :readonly="ro.caipinOldMoney"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="现价/份" prop="caipinNewMoney">
                       <el-input v-model="ruleForm.caipinNewMoney"
                                 placeholder="现价/份" clearable  :readonly="ro.caipinNewMoney"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="现价/份" prop="caipinNewMoney">
                           <el-input v-model="ruleForm.caipinNewMoney"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.caipinContent"  label="菜品介绍" prop="caipinContent">
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    caipinName: false,
                    caipinUuidNumber: true,
                    caipinPhoto: false,
                    zanNumber: false,
                    caiNumber: false,
                    caipinTypes: false,
                    caipinKucunNumber: false,
                    caipinOldMoney: false,
                    caipinNewMoney: false,
                    caipinClicknum: false,
                    caipinContent: false,
                    shangxiaTypes: false,
                    caipinDelete: false,
                    insertTime: false,
                ...
                rules: {
                   ...
                   caipinClicknum: [
                              { required: true, message: '菜品热度不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
