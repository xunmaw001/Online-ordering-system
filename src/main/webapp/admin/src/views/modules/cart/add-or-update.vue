            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='caipin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="菜品编号" prop="caipinUuidNumber">
                        <el-input v-model="caipinForm.caipinUuidNumber"
                                  placeholder="菜品编号" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='caipin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="赞" prop="zanNumber">
                        <el-input v-model="caipinForm.zanNumber"
                ...
                <el-col :span="12"  v-if="sessionTable !='caipin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="踩" prop="caiNumber">
                        <el-input v-model="caipinForm.caiNumber"
                ...
                <el-col :span="12"  v-if="sessionTable !='caipin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="菜品库存" prop="caipinKucunNumber">
                        <el-input v-model="caipinForm.caipinKucunNumber"
                                  placeholder="菜品库存" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="菜品库存" prop="caipinKucunNumber">
                            <el-input v-model="ruleForm.caipinKucunNumber"
                                      placeholder="菜品库存" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='caipin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="菜品原价" prop="caipinOldMoney">
                        <el-input v-model="caipinForm.caipinOldMoney"
                                  placeholder="菜品原价" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="菜品原价" prop="caipinOldMoney">
                            <el-input v-model="ruleForm.caipinOldMoney"
                                      placeholder="菜品原价" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='caipin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="菜品热度" prop="caipinClicknum">
                        <el-input v-model="caipinForm.caipinClicknum"
                                  placeholder="菜品热度" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="菜品热度" prop="caipinClicknum">
                            <el-input v-model="ruleForm.caipinClicknum"
                                      placeholder="菜品热度" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
