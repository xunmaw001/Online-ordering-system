    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="评价内容" prop="caipinCommentbackText">
                        <el-input type="textarea"  :readonly="ro.caipinCommentbackText" v-model="ruleForm.caipinCommentbackText" placeholder="评价内容"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.caipinCommentbackText" label="评价内容" prop="caipinCommentbackText">
                            <span v-html="ruleForm.caipinCommentbackText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            if (this.role != "管理员"){
                this.ro.caipinId = true;//菜品
                this.ro.yonghuId = true;//用户
                this.ro.caipinCommentbackText = true;//评价内容
            }else{
            }
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`caipinCommentback/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.caipinCommentbackCrossAddOrUpdateFlag = false;
                                        this.parent.search();
