...
var centerMenu = [
    ...
    ,{
        name: '菜品收藏',
        url: '../caipinCollection/list.html'
    }
    ,{
        name: '菜品订单',
        url: '../caipinOrder/list.html'
    }
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/wangshangdingcan/admin/dist/index.html#/login";
