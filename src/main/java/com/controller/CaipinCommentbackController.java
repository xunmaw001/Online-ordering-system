...
public class CaipinCommentbackController {
    ...
    private static final String TABLE_NAME = "caipinCommentback";
    ...
    */
    ...
    public R update(@RequestBody CaipinCommentbackEntity caipinCommentback, HttpServletRequest request) throws NoSuchFieldException, ClassNotFoundException, IllegalAccessException, InstantiationException {
        logger.debug("update方法:,,Controller:{},,caipinCommentback:{}",this.getClass().getName(),caipinCommentback.toString());
        CaipinCommentbackEntity oldCaipinCommentbackEntity = caipinCommentbackService.selectById(caipinCommentback.getId());//查询原先数据
...
//            caipinCommentback.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
    ...
    */
    ...
    public R delete(@RequestBody Integer[] ids, HttpServletRequest request){
        ...
        List<CaipinCommentbackEntity> oldCaipinCommentbackList =caipinCommentbackService.selectBatchIds(Arrays.asList(ids));//要删除的数据
...
//                            caipinCommentbackEntity.setCaipinId(Integer.valueOf(data.get(0)));   //菜品 要改的
...
//                            caipinCommentbackEntity.setUpdateTime(sdf.parse(data.get(0)));          //回复时间 要改的
