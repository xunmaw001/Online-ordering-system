...
public class CaipinCollectionController {
    ...
    private static final String TABLE_NAME = "caipinCollection";
    ...
    */
    ...
    public R save(@RequestBody CaipinCollectionEntity caipinCollection, HttpServletRequest request){
        ...
        if(false)
            ...
            caipinCollection.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        ...
        Wrapper<CaipinCollectionEntity> queryWrapper = new EntityWrapper<CaipinCollectionEntity>()
            ...
            .eq("caipin_collection_types", caipinCollection.getCaipinCollectionTypes())
            ;
    ...
    */
    ...
    public R update(@RequestBody CaipinCollectionEntity caipinCollection, HttpServletRequest request) throws NoSuchFieldException, ClassNotFoundException, IllegalAccessException, InstantiationException {
        logger.debug("update方法:,,Controller:{},,caipinCollection:{}",this.getClass().getName(),caipinCollection.toString());
        CaipinCollectionEntity oldCaipinCollectionEntity = caipinCollectionService.selectById(caipinCollection.getId());//查询原先数据
...
//            caipinCollection.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
    ...
    */
    ...
    public R delete(@RequestBody Integer[] ids, HttpServletRequest request){
        ...
        List<CaipinCollectionEntity> oldCaipinCollectionList =caipinCollectionService.selectBatchIds(Arrays.asList(ids));//要删除的数据
    ...
    public R save( String fileName, HttpServletRequest request){
        ...
        try {
            List<CaipinCollectionEntity> caipinCollectionList = new ArrayList<>();//上传的东西
                ...
                if(!".xls".equals(suffix)){
                    ...
                    if(!file.exists()){
                        ...
                        for(List<String> data:dataList){
                            //循环
                            CaipinCollectionEntity caipinCollectionEntity = new CaipinCollectionEntity();
//                            caipinCollectionEntity.setCaipinId(Integer.valueOf(data.get(0)));   //菜品 要改的
//                            caipinCollectionEntity.setYonghuId(Integer.valueOf(data.get(0)));   //用户 要改的
//                            caipinCollectionEntity.setCaipinCollectionTypes(Integer.valueOf(data.get(0)));   //类型 要改的
//                            caipinCollectionEntity.setInsertTime(date);//时间
//                            caipinCollectionEntity.setCreateTime(date);//时间
                            caipinCollectionList.add(caipinCollectionEntity);
                        ...
                        //查询是否重复
                        caipinCollectionService.insertBatch(caipinCollectionList);
                        return R.ok();
                    }
                }
            }
    ...
    */
    ...
    public R add(@RequestBody CaipinCollectionEntity caipinCollection, HttpServletRequest request){
        ...
        Wrapper<CaipinCollectionEntity> queryWrapper = new EntityWrapper<CaipinCollectionEntity>()
            ...
            .eq("yonghu_id", caipinCollection.getYonghuId())
            .eq("caipin_collection_types", caipinCollection.getCaipinCollectionTypes())
//            .notIn("caipin_collection_types", new Integer[]{102})
            ;
        logger.info("sql语句:"+queryWrapper.getSqlSegment());
        CaipinCollectionEntity caipinCollectionEntity = caipinCollectionService.selectOne(queryWrapper);
        if(caipinCollectionEntity==null){
