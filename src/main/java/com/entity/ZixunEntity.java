...
public class ZixunEntity<T> implements Serializable {
     ...
     * 美食资讯名称
     */
    @ColumnInfo(comment="美食资讯名称",type="varchar(200)")
     ...
     * 美食资讯图片
     */
    @ColumnInfo(comment="美食资讯图片",type="varchar(200)")
     ...
     * 美食资讯类型
     */
    @ColumnInfo(comment="美食资讯类型",type="int(11)")
     ...
     * 美食资讯详情
     */
    @ColumnInfo(comment="美食资讯详情",type="longtext")
